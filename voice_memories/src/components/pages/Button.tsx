...
const variantStyles = {
  solid: {
    cyan: 'relative overflow-hidden bg-[#008080] text-white before:absolute before:inset-0 active:before:bg-transparent hover:before:bg-white/10 active:bg-cyan-600 active:text-white/80 before:transition-colors',
    white:
      'bg-white text-cyan-900 hover:bg-white/90 active:bg-white/90 active:text-cyan-900/70',
    gray: 'bg-gray-800 text-white hover:bg-gray-900 active:bg-gray-800 active:text-white/80',
    gold: 'border-[#EACB1B] bg-black text-white hover:bg-[#333333] focus:ring-[#EACB1B]',
  },
  outline: {
