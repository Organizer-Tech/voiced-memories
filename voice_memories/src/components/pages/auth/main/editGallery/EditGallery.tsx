...
function EditGallery() {
    ...
    const handleImageClick = (photo: PhotoProps) => {
        ...
        if(currentSound){
            audioBlob = base64ToBlob(currentSound, 'audio/mp3; codecs="aac');
    ...
    const startRecording = async () => {
        try {
          ...
          mediaRecorder.current.onstop = () => {
            ...
            const blob = new Blob(chunks.current, { type: 'audio/mp3; codecs="aac' });
    ...
    const handleConfirmRecord = async () => {
        ...
        if (session != null) {
            ...
            if(blobRef.current) {
                ...
                createAudioFileFromBlob(blobRef.current,'audio.mp3','audio/mp3; codecs="aac')
                .then(async (file) => {
